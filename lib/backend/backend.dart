...
import 'schema/emailand_password_record.dart';
...
export 'schema/emailand_password_record.dart';
export 'schema/images_record.dart';

/// Functions to query EmailandPasswordRecords (as a Stream and as a Future).
Future<int> queryEmailandPasswordRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      EmailandPasswordRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<EmailandPasswordRecord>> queryEmailandPasswordRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      EmailandPasswordRecord.collection,
      EmailandPasswordRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<EmailandPasswordRecord>> queryEmailandPasswordRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
